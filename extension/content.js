    ...
    if (silencedPairs?.length > 0) {
      silencedToShow = silencedPairs
        ...
        .map(p => ({
          ...
          // New 4-section AI explanation fields
          fullExplanation: p.aiExplanation?.fullExplanation || null,
          whySilencedAI: p.aiExplanation?.whySilenced || null,
          whoAffectedAI: p.aiExplanation?.whoAffected || null,
          whyMattersAI: p.aiExplanation?.whyMatters || null,
          counterfactualAI: p.aiExplanation?.counterfactual || null,
          whyGood: p.whyGood,
